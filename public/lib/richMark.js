...
(function () {
    ...
    RichMarker.prototype.draw = function () {
        ...
        if (this._opts.zIndex) {
            this._container.style.zIndex = this._opts.zIndex;
        }
    }
    ...
    RichMarker.prototype.resetZIndex = function () {
        this.setZIndex(BMap.Overlay.getZIndex(this.getPosition().lat));
    }
    /**
     * 添加用户的自定义的内容
     * 
